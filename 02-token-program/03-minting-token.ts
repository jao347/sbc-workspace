...
async function main(){
    ...
    const base58DecodedPK = base58.decode(process.env.SOL_PRIVATE_KEY || 'vMGwccjmUb1WkJuMGjbswZxovk3wkDTd6HkgMu3Q74maPdfcfp2rHhJ6LYP44Yuit1ExUdcu6cawoBmqRA2VQbM');
